                ...
                <div class="card-body m-2">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height:150px" name="content" value="{{old('content')}}" placeholder="Content"></textarea>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="valid">
                                ...
                                <option value="1" @if (old('valid') == "1") {{ 'selected' }} @endif>Yes</option>
                                <option value="0" @if (old('valid') == "0") {{ 'selected' }} @endif>No</option>
                            </select>
                        </div>
                    </div>
